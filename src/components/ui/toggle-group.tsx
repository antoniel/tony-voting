...
import { Toggle as ToggleComponent, toggleVariants } from '@/components/ui/toggle'
...
function ToggleGroup({
  ...
  return (
    <ToggleGroupPrimitive
      ...
      data-size={size}
      className={cn('flex w-fit *:pointer-coarse:after:min-w-auto', variant === 'default' ? 'gap-0.5' : '[--clip-end:-1rem] [--clip-start:-1rem]', className)}
      {...props}
    >
