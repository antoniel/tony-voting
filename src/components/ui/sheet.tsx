    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Popup
        ...
        className={cn(
          ...
          side === 'top' && 'inset-x-0 top-0 h-auto data-ending-style:-translate-y-full data-starting-style:-translate-y-full',
          side === 'bottom' && 'inset-x-0 bottom-0 h-auto data-ending-style:translate-y-full data-starting-style:translate-y-full',
          className
        )}
        {...props}
      >
