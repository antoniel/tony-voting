...
function Combobox<ItemValue, SelectedValue = ItemValue, Multiple extends boolean | undefined = false>(
...
function ComboboxPopup({
  ...
  return (
    <ComboboxPrimitive.Portal>
      <ComboboxPrimitive.Positioner data-slot="combobox-positioner" className="z-50 select-none" sideOffset={sideOffset} anchor={chipsRef}>
...
function ComboboxEmpty({ className, ...props }: ComboboxPrimitive.Empty.Props) {
  return <ComboboxPrimitive.Empty className={cn('text-center text-sm text-muted-foreground not-empty:p-2', className)} data-slot="combobox-empty" {...props} />
}
