...
function Frame({ className, ...props }: React.ComponentProps<'div'>) {
  return <div data-slot="frame" className={cn('relative flex flex-col rounded-2xl bg-muted p-1', className)} {...props} />
}
...
function FrameHeader({ className, ...props }: React.ComponentProps<'header'>) {
  return <header data-slot="frame-panel-header" className={cn('flex flex-col px-5 py-4', className)} {...props} />
}
...
function FrameDescription({ className, ...props }: React.ComponentProps<'div'>) {
  return <div data-slot="frame-panel-description" className={cn('text-sm text-muted-foreground', className)} {...props} />
}

function FrameFooter({ className, ...props }: React.ComponentProps<'footer'>) {
  return <footer data-slot="frame-panel-footer" className={cn('flex flex-col gap-1 px-5 py-4', className)} {...props} />
}
